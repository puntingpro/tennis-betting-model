...
def main():
    ...
    p_summarize = analysis_subparsers.add_parser("summarize-tournaments", help="Summarize results by tournament.")
    ...
    p_pipeline = subparsers.add_parser("pipeline", help="Run a single pipeline instance.")
