...
from src.scripts.utils.consolidate_data import main as consolidate_data_main
from src.scripts.utils.consolidate_rankings import main as consolidate_rankings_main
...
def main():
    ...
    # --- CLI Commands ---
    # --- MODIFIED: Correctly call the consolidation functions ---
    p_consolidate = subparsers.add_parser("consolidate", help="Consolidate all raw data files.")
    p_consolidate.set_defaults(func=lambda args: (consolidate_data_main(), consolidate_rankings_main()))
