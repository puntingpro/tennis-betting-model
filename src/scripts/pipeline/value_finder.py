...
def process_markets(model, market_catalogues, market_book_lookup, player_info_lookup, df_rankings, df_matches, betting_config):
    ...
    for market in market_catalogues:
        ...
        try:
            ...
            p1_win_perc, p1_surface_win_perc, _ = get_player_form_and_win_perc(df_matches, p1_id, surface, match_date)
            p2_win_perc, p2_surface_win_perc, _ = get_player_form_and_win_perc(df_matches, p2_id, surface, match_date)
            h2h_p1_wins, h2h_p2_wins = get_h2h_stats(df_matches, p1_id, p2_id, match_date)
            ...
            feature_dict = {
                ...
                'h2h_p1_wins': h2h_p1_wins, 'h2h_p2_wins': h2h_p2_wins, 'h2h_win_perc_p1': h2h_win_perc_p1,
                'p1_win_perc': p1_win_perc, 'p2_win_perc': p2_win_perc,
                'p1_surface_win_perc': p1_surface_win_perc, 'p2_surface_win_perc': p2_surface_win_perc,
